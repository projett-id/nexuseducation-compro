   ...
   <div class="container" data-aos="fade-up">
        <article class="article">
            <div class="article-header">
                ...
                <h1 class="title" data-aos="fade-up" data-aos-delay="100">{{ $event->title }}</h1>
                ...
                <div class="article-meta" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="post-info">
                            <span><i class="bi bi-calendar4-week"></i> {{ $event->FormattedSchedule }}</span>
                    </div>
                </div>
            </div>
            <div class="article-featured-image" data-aos="zoom-in">
                <img src="{{ asset('storage/'.$event->thumbnail) }}" alt="" class="img-fluid">
            </div>
